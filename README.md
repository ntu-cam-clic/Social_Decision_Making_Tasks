...
* **example_Code_Data_Preprocessing** folder. This folder contains an example raw dataset from Qualtrics and scripts for preprocessing the raw data (generated after running the Singapore code: QualtricsCode_socialDMtasks_Singapore_Dataset.qsf) and generating the exclusion criteria filters.
...
* <span style="color:red;"><b>QualGames_allTasks.qsf</b></span>. Users are suggested to use this file to deploy the tasks. It is a combined version of the two .qsf files described above and contains all tasks used to collect the Singapore and U.S. datasets. Each task is contained within a single Qualtrics block, allowing for flexible and modular implementation. Users can simply delete tasks they do not need and can use Qualtrics branching and randomization functions to customize task order.
