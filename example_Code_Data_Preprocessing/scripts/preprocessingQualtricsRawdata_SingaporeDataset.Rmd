...
# raw data exported from Qualtrics. You can find a small raw data file named rawDataFromQualtrics_Singapore_Dataset.csv in the same folder as this script. 
...
rawdata = read.csv('rawDataFromQualtrics_Singapore_Dataset.csv',check.names=FALSE);  # load the data from one Qualtrics account,check.names=FALSE to keep space in names
