...
* **$${\color{red}QualGames_allTasks.qsf}$$**. Users are suggested to use this file to deploy the tasks. It is a combined version of the two .qsf files described above and contains all tasks used to collect the Singapore and U.S. datasets. Each task is contained within a single Qualtrics block, allowing for flexible and modular implementation. Users can simply delete tasks they do not need and can use Qualtrics branching and randomization functions to customize task order.
